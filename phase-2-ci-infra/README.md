...
1. [**Step 1: Terraform Linting and Formatting**](./01-lint-format/README.md) *(Completed)*
2. [**Step 2: IaC Security Scanning with Checkov/Terrascan**](./02-security-scan/README.md) *(Completed)*
3. [**Step 3: Terraform Plan Execution**](./03-terraform-plan/README.md) *(Completed)*
